            ...
            <form @submit.prevent="handleSubmit" >
                <div class="form-group mb-4">
                    ...
                    <div class="form-input-password">
                        <input :type="showNewPassword ? 'text' : 'password'" v-model="newPassword" name="newPassword" class="form-control" :class="{ 'is-invalid': submitted && newPasswordError }" placeholder="記号を含む半角英数8文字以上で入力" />
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="form-input-password">
                        <input :type="showConfirmNewPassword ? 'text' : 'password'" v-model="confirmNewPassword" name="confirmNewPassword" class="form-control" :class="{ 'is-invalid': submitted && confirmNewPasswordError }" placeholder="記号を含む半角英数8文字以上で入力" />
