          ...
          <div class="form-group mb-4">
            ...
            <div class="form-input-password">
              <input
                ...
                name="newPassword"
                class="form-control"
                :class="{ 'is-invalid': submitted && newPasswordError }"
            ...
            <div
              v-show="submitted && newPasswordError"
          ...
          <div class="form-group mb-4">
            ...
            <div class="form-input-password">
              <input
                ...
                class="form-control"
                :class="{ 'is-invalid': submitted && confirmNewPasswordError }"
                placeholder="記号を含む半角英数8文字以上で入力"
              />
              <div
                class="toggle-btn"
                :class="{ show: showConfirmNewPassword }"
            ...
            <div
              v-show="submitted && confirmNewPasswordError"
              class="invalid-feedback"
            >
